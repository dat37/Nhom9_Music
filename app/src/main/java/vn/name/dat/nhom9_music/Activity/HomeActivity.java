...
import vn.name.dat.nhom9_music.Adapter.MainViewPagerAdapter;
import vn.name.dat.nhom9_music.Fragment.Fragment_Profile;
import vn.name.dat.nhom9_music.Fragment.Fragment_Thu_Vien;
import vn.name.dat.nhom9_music.Fragment.Fragment_Tim_Kiem;
import vn.name.dat.nhom9_music.Fragment.Fragment_Trang_Chu;
import vn.name.dat.nhom9_music.Fragment.LoadingDialog;
import vn.name.dat.nhom9_music.R;
import vn.name.dat.nhom9_music.Service_Local.ForegroundServiceControl;
